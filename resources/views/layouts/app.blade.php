...
<div class="sh-headpanel">
    <div class="sh-headpanel-left">
        ...
        @if(Auth::user()->role <= 3)
            ...
            @if(Auth::user()->role <= 2)
                <a href="{{ route('ActivityUsers', ['project' => 'all']) }}"
                   class="sh-icon-link">
                    <div>
                        <i class="icon ion-stats-bars"></i>
        ...
        @if(Auth::user()->role <= 3 || Auth::user()->id === 4)
            ...
            <div class="dropdown-menu dropdown-menu-right">
                ...
                <ul class="dropdown-profile-nav">
                    <li><a href="{{ route('edit-profile', Auth::user()->id) }}"><i class="icon ion-ios-person"></i>
                            Профиль</a></li>
                    <li><a href="{{ route('ActivityUser', ['user' => Auth::user()->id]) }}"><i
                                    class="icon ion-android-calendar"></i>
                            Статистика по деятельности</a></li>
                    {{--                    @if(array_key_exists(4, Auth::user()->positions()))--}}
