...
@section('content')
    ...
    @endif
    <form autocomplete="off" action="{{ route('set-MiOVisitions') }}" method="post" class="form-layout col-lg-12">
        {{ csrf_field() }}
            ...
            <div class="col-lg-8">
                <div class="col-lg-12">
                    <div class="form-group">
                        ...
                        <input class="form-control" id="datetime" type="text" lang="ru" name="datetime"
                ...
                <div class="col-lg-12">
                    <div class="form-group mg-b-10-force">
                        ...
                        <input class="form-control" type="text" name="phone" id="phone" data-parsley-trigger="change"
                ...
                <div class="col-lg-12">
                    <div class="form-group">
                        <label class="form-control-label" for="name">Наименование объекта: <span
                                    class="tx-danger">*</span></label>
                        <input class="form-control" name="name" id="name" data-parsley-trigger="change" required>
                    </div>
                </div><!-- col-12 -->
                <div class="col-lg-12">
                    <div class="form-group mg-b-10-force sel2">
                ...
                <div class="col-lg-12">
                    <div class="form-group">
                        <label class="form-control-label" for="address">Адрес объекта / Описание места продажи: <span
                                    class="tx-danger">*</span></label>
                        <input class="form-control" name="address" id="address" data-parsley-trigger="change" required>
                    </div>
                </div><!-- col-12 -->
                <div class="col-lg-12">
                    <div class="form-group">
            ...
            <div class="table-responsive mg-b-25 col-lg-4">
                ...
                <table class="table table-hover table-bordered table-primary mg-b-0">
                    ...
                    <tr>
                        ...
                        <td class="text-md-center valign-middle">
                            <label>
                                <input class="tools" type="checkbox" name="availabilitySyringes2" data-data="Syringes2"
                                       value="1" data-language="visit"/>
                            </label>
                        </td>
                        <td class="text-md-center valign-middle">
                            <label>
                                <input type="checkbox" name="procurementSyringes2" data-data="Syringes2"
                    ...
                    <tr>
                        ...
                        <td class="text-md-center valign-middle">
                            <label>
                                <input class="tools" type="checkbox" name="availabilitySyringes5" data-data="Syringes5"
                                       value="1" data-language="visit"/>
                            </label>
                        </td>
                        <td class="text-md-center valign-middle">
                            <label>
                                <input type="checkbox" name="procurementSyringes5" data-data="Syringes5"
                                       value="1" data-language="visit" data-disabled="true"/>
                            </label>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="text-md-center valign-middle">
                            <label>
                                <input class="tools" type="checkbox" name="availabilitySyringes10"
                                       data-data="Syringes10" value="1" data-language="visit"/>
                            </label>
                        </td>
                        <td class="text-md-center valign-middle">
                            <label>
                                <input type="checkbox" name="procurementSyringes10" data-data="Syringes10"
                                       value="1" data-language="visit" data-disabled="true"/>
                            </label>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="text-md-center valign-middle">
                            <label>
                                <input class="tools" type="checkbox" name="availabilityDoily" data-data="Doily"
                                       value="1" data-language="visit"/>
                            </label>
                        </td>
                        <td class="text-md-center valign-middle">
                            <label>
                                <input type="checkbox" name="procurementDoily" data-data="Doily" value="1"
                                       data-language="visit"
                                       data-disabled="true"/>
                            </label>
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="text-md-center valign-middle">
                            <label>
                                <input class="tools" type="checkbox" name="availabilityCondomsM" data-data="CondomsM"
                                       value="1" data-language="visit"/>
                            </label>
                        </td>
                        <td class="text-md-center valign-middle">
                            <label>
                                <input type="checkbox" name="procurementCondomsM" data-data="CondomsM"
                                       value="1" data-language="visit" data-disabled="true"/>
                            </label>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="text-md-center valign-middle">
                            <label>
                                <input class="tools" type="checkbox" name="availabilityCondomsW" data-data="CondomsW"
                                       value="1" data-language="visit"/>
                            </label>
                        </td>
                        <td class="text-md-center valign-middle">
                            <label>
                                <input type="checkbox" name="procurementCondomsW" data-data="CondomsW"
                                       value="1" data-language="visit" data-disabled="true"/>
                            </label>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="text-md-center valign-middle">
                            <label>
                                <input class="tools" type="checkbox" name="availabilityHivBlood" data-data="HivBlood"
                                       value="1" data-language="visit"/>
                            </label>
                        </td>
                        <td class="text-md-center valign-middle">
                            <label>
                                <input type="checkbox" name="procurementHivBlood" data-data="HivBlood"
                                       value="1" data-language="visit" data-disabled="true"/>
                            </label>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="text-md-center valign-middle">
                            <label>
                                <input class="tools" type="checkbox" name="availabilityHivSpittle"
                                       data-data="HivSpittle" value="1" data-language="visit"/>
                            </label>
                        </td>
                        <td class="text-md-center valign-middle">
                            <label>
                                <input type="checkbox" name="procurementHivSpittle" data-data="HivSpittle"
                                       value="1" data-language="visit" data-disabled="true"/>
                            </label>
                        </td>
                    </tr>
