...
Route::group(['prefix' => App\Http\Middleware\LocaleMiddleware::getLocale()], function () {
    ...
    Route::prefix('indicators')->group(function () {
        ...
        Route::get('/save', 'IndicatorsController@save')->name('indicatorsSave');
...
//        Route::get('/temp/registration/{user}/{position}', 'ActivityController@tempRegistrationUser')->name('tempRegistrationUser');
    ...
    Route::prefix('statistics')->group(function () {
        ...
        Route::get('/activities/user/{id}/verification', 'ActivityStatisticsController@verification')->name('ActivityVerification');
